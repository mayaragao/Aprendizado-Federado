...
class CifarClient(fl.client.NumPyClient):
    ...
    #def fit(self, parameters, config):
    #    model.set_weights(parameters)
    #    x = random.randint(0, 1820) #ate 2100
    #    model.fit(x_train[x:x+280],y_train[x:x+280],validation_split=0.2,batch_size=70,epochs=5,verbose=1)
    #    numero_classes(y_train[x:x+280])
    #    return model.get_weights(), len(x_train[x:x+280]), {}
